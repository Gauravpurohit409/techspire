...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto px-4 py-20 font-sans antialiased md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2 lg:grid-cols-12">
        {/* IMAGE SECTION */}
        ...
        <div className="lg:col-span-8 flex flex-col justify-between py-4">
          ...
          {/* NAVIGATION BUTTONS */}
          <div className="flex justify-end w-full gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-8 w-8 items-center justify-center rounded-full bg-muted"
            >
