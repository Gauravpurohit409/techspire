...
export const faqs = [
  {
    id: "faq-1",
    question:
      "What makes Techspire Hub different from other software companies?",
    answer:
      "We go beyond just coding — we focus on creating impactful digital solutions that align with your business goals. Our blend of strategy, creativity, and technology ensures every project delivers real, measurable value.",
  },
  {
    id: "faq-2",
    question: "What types of businesses do you work with?",
    answer:
      "We collaborate with startups, SMEs, and enterprises across industries such as SaaS, e-commerce, healthcare, finance, and logistics. Our flexible approach allows us to adapt to any scale or complexity.",
  },
  {
    id: "faq-3",
    question: "Do you provide end-to-end project management?",
    answer:
      "Yes. From discovery and design to development, deployment, and support, we manage the entire lifecycle. Each project includes dedicated communication, milestone tracking, and transparent reporting.",
  },
  {
    id: "faq-4",
    question: "Do you offer ongoing support after launch?",
    answer:
      "Absolutely. We provide post-launch maintenance, performance monitoring, and updates to keep your systems secure, optimized, and scalable as your business grows.",
  },
  {
    id: "faq-5",
    question: "How do you ensure data security and confidentiality?",
    answer:
      "We follow strict security protocols and sign NDAs to protect client information. Our systems use encryption, secure authentication, and industry-standard best practices to ensure data integrity.",
  },
  {
    id: "faq-6",
    question: "How can we get started with Techspire Hub?",
    answer:
      "Simply reach out through our contact form or schedule a consultation. We’ll discuss your goals and craft a tailored roadmap to bring your digital vision to life.",
  },
];
